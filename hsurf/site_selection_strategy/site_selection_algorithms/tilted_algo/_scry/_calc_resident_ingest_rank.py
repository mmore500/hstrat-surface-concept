...
def _get_cur_epoch_hanoi_count(
    ...
    """How many instances of the focal hanoi value have been ingested during
    the current epoch?"""
...
def _calc_resident_rank_stale_case(
    ...
    invasion_rank = calc_hanoi_invasion_rank(hanoi_value, epoch, surface_size)
    if invasion_rank <= rank:
        return calc_resident_ingest_rank(  # recurse to main func
            site,
            surface_size,
