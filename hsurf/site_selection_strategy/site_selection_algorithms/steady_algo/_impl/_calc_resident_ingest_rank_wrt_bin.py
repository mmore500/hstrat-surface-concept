...
def calc_resident_ingest_rank_wrt_bin(
    bin_number: int,
    ...
    "chaff" ingests, i.e., ingests placed onto the surface for expired
    hanoi values using lookahead to the next site where a non-expired ingest
    will be made.
    """
    if num_ingests == 0:
        return 0
