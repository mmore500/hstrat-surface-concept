...
def calc_tilted_ratios(retained_ranks: np.array, current_rank: int) -> np.array:
    ...
    - Otherwise, the number of tilted ratios returned is always
      len(retained_ranks) + 1.
    ...
    return gap_sizes / np.maximum(current_rank - gap_highest_ranks, 1)
