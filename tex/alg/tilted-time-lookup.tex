...
\begin{minipage}{0.55\textwidth}
    ...
    \Function{NaiveTiltedLookup}{$\colorS, \colorT$} \Comment{Assume buffer has been filled} \\
        ...
        \State $\texttt{bool\_t} ~ ~ X_B' \gets (\colorh' = \colort - \colort_0) \wedge (\colorT_r \geq \colorT) \wedge (\colort < \colorS - \colors) $ \Comment{This site $\colork$ to be refilled after invasion during current epoch?}
