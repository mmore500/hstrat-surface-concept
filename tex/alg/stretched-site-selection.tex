\begin{algorithm}[H]
\caption{Stretched algorithm site selection $\colorK_{\colorS}(\colorT)$. Supplementary Listing \ref{lst:stretched_site_selection.py} provides reference Python code.}
...
\begin{minipage}{0.53\textwidth}
    ...
    \begin{algorithmic}[1]
        ...
        \Statex
        \State $\texttt{uint\_t} ~ ~ \epsilon_{\colork} = \Call{I}{b_l > 0}$  \Comment{Correction factor, 0\textsuperscript{th} bunch (i.e., bunch $r=\colors$ at site $\colork=0$)}
