...
\begin{minipage}{0.53\textwidth}
    ...
    \begin{algorithmic}[1]
        ...
        \State $\texttt{uint\_t} ~ ~ \colort_0 \gets 2^{\tau} - \tau$ \Comment{First epoch of meta-epoch}
        \State $\texttt{uint\_t} ~ ~ \colort_0 \gets 2^{\tau + 1} - (\tau + 1)$ \Comment{First epoch of next meta-epoch}
