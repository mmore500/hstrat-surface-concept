...
\}.
\end{align*}
In practice, this requires repeatedly discarding all items with lowest hanoi value $\colorH(\colorTbar) = n(\colorT)$ as time elapses.
...
Although segment count increases across bunches $i$, decreases by 1 each bunch as $\colors - i$.
