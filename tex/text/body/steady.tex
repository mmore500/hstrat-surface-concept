...
As given in Equation \ref{eqn:steady-cost} in Section \ref{sec:stream-curation-problem}, the steady criterion's cost function is the largest gap size between retained data items, $\max_{\colorTbar} \colorG_{\colorT}(\colorTbar)$.
