...
One foundational abstraction is the corresponding value in the ``ruler'' integer sequence $\colorH(\colorTbar) = \max \{ n \in \mathbb{Z}_{\geq0} : (\colorTbar + 1) \bmod 2^n = 0 \}$.
