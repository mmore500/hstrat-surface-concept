...
\input{fig/surface-site-deposit.tex}
\input{fig/deposit-rank-calculation.tex}

\input{fig/instance-reservation-layout-bad.tex}
\input{fig/longevity-ordering.tex}

\input{fig/doubling-instance-reservation.tex}
\input{fig/incrementing-instance-reservation.tex}
