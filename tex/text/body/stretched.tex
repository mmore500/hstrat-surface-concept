...
\end{align*}
By construction, $\textsf{goal\_stretched} \subset \{ \colorTbar \in [0 \twodots \colorT] \}$.
...
% Then, $\exists \colorTbar$ such that $[\colorTbar \twodots 2\times\colorTbar] \in \colorBnot_{\colorT}$.
% Because $\exists 0 \leq n < \colorS$ such that $2^n - 1 \in [\colorTbar \twodots 2\times\colorTbar]$, this would imply $
