...
binder/teeplots/41/num-generations=128+surface-size=32+viz=site-reservation-by-rank-spliced-at-heatmap+ext=.pdf}
...
\end{minipage}
  ...
  \vspace{0pt}
    \centering
    \includegraphics[width=0.88\linewidth,clip]{binder/teeplots/41/num-generations=4096+surface-size=64+viz=stratum-persistence-dripplot+ext=.pdf}
  \end{subfigure}%
  \begin{subfigure}[t]{0.35\linewidth}
  \vspace{-2pt}
  \caption{%
...
\vspace{0pt}
  \centering
  \includegraphics[width=0.88\linewidth,clip]{binder/teeplots/41/hue=kind+surface-size=16+viz=criterion-satisfaction-lineplot+x=rank+y=stretched-criterion+ext=.pdf}
\end{subfigure}%
\begin{subfigure}[t]{0.35\linewidth}
\vspace{-2pt}
\caption{%
