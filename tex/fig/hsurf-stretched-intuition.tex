...
\node[anchor=west, text=black!100] (texta) at (24.5, 3.5) {$r=1$};
\node[anchor=west, text=black!70] (textb) at (24.5, 2.5) {$r=2$};
\node[anchor=west, text=black!50] (textc) at (21.5, 1.5) {Bunch $r=3$};
\node[anchor=west, text=black!30] (textd) at (21.5, 0.5) {Bunch $r=5$};
