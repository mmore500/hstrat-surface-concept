\begin{figure*}[htbp!]
  ...
  \includegraphics[width=\textwidth, clip, trim={0 1.25cm 1.25cm 0}]{binder/teeplots/20/surface-size=16+viz=site-reservation-at-ranks-heatmap+ext=.pdf}
  \end{subfigure}%
  \begin{subfigure}{0.5\textwidth}
  \includegraphics[width=\textwidth, clip, trim={1.25cm 1.25cm 0 0}]{binder/teeplots/20/plotter=size+surface-size=16+viz=site-reservation-at-ranks-heatmap+ext=.pdf}
  \end{subfigure}
...
% Add text
\node[anchor=west, text=black!100] (texta) at (27.0, 3.5) {Bunch $r=1$};
\node[anchor=west, text=black!70] (textb) at (27.0, 2.5) {Bunch $r=2$};
\node[anchor=west, text=black!50] (textc) at (27.0, 1.5) {Bunch $r=3$};
\node[anchor=west, text=black!30] (textd) at (27.0, 0.5) {Bunch $r=5$};
...
\draw[-, line width=7pt, draw=black!100](textaa.east) -- (textab.west);
\draw[-, line width=7pt, draw=black!100](textab.east) -- (textac.west);
\draw[-, line width=7pt, draw=black!100](textac.east) -- (textad.west);
\draw[-, line width=7pt, draw=black!100](textad.east) -- (texta.west);
...
\draw[-,line width=7pt,draw=black!70](textba.east) -- (textbb.west);
\draw[-,line width=7pt,draw=black!70](textbb.east) -- (textb.west);
...
\draw[-, line width=7pt,draw=black!50](textca.east) -- (textc.west);
...
\draw[-, line width=7pt,draw=black!30](textda.east) -- (textd.west);
...
\begin{subfigure}{0.5\textwidth}
\includegraphics[width=\textwidth, clip, trim={0 0 1.25cm 11.2cm}]{binder/teeplots/20/surface-size=16+viz=site-reservation-at-ranks-heatmap+ext=.pdf}
...
\end{subfigure}%
\begin{subfigure}{0.5\textwidth}
\includegraphics[width=\textwidth, clip, trim={1.25cm 0 0 11.2cm}]{binder/teeplots/20/plotter=size+surface-size=16+viz=site-reservation-at-ranks-heatmap+ext=.pdf}
