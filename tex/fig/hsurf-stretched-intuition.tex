...
\end{subfigure}
  \caption{
    ...
    \footnotesize
    First panel \ref{fig:hsurf-stretched-intuition-site-selection} shows placement strategy for data items with hanoi value $\colorH(\colorT) = 0$ on a buffer of size $\colorS=8$.
    ...
    The first data item instance with hanoi value $\colorH(\colorT) = 0$ is placed in segment bunch 0, which only contains one segment: segment 0.
