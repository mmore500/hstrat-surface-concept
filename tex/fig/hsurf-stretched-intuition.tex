...
% Add text
\node[anchor=west] (texta) at (27, 3.5) {Bunch $r=1$};
% Left side arrows
...
% Add text
\node[anchor=west] (textb) at (27, 2.5) {Bunch $r=2$};
...
\node[anchor=west] (textc) at (27, 1.5) {Bunch $r=3$};
...
\node[anchor=west] (textd) at (27, 0.5) {Bunch $r=4$};
