...
\caption{
    \textbf{Physical storage layout of \hv{} reservations.}
    \footnotesize
    Epoch-by-epoch storage layout of \hv{} reservation ``segments''  for buffer size $S=16$, shown as contiguous horizontal regions divided by solid black line.
