\begin{figure*}[htbp!]
  ...
  \includegraphics[width=\textwidth, clip, trim={0 1.25cm 0 0}]{binder/teeplots/20/plotter=size+surface-size=16+viz=site-reservation-at-ranks-heatmap+ext=.pdf}
  \end{subfigure}%
...
% \end{subfigure}%
\begin{subfigure}{0.5\textwidth}
\includegraphics[width=\textwidth, clip, trim={0 0 1.25cm 11.2cm}]{binder/teeplots/20/plotter=size+surface-size=16+viz=site-reservation-at-ranks-heatmap+ext=.pdf}\vspace{-1ex}
