...
\end{subfigure}
  \caption{
    ...
    Reservation segments are separated by black lines in both diagram.
    On left, inverted triangles schematize layout of segment bunches, which are nested and discontiguous.
