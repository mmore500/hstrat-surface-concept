\begin{figure*}[htbp!]
  ...
  \includegraphics[width=\textwidth, clip, trim={0 1.25cm 0 0}]{binder-20a-tilted-eulerian-surface/binder/teeplots/20a/color-epoch-t=black+color-metaepoch-tau=black+color-site-k=black+plotter=site_reservation_size_at_rank_heatmap+surface-size=16+swap-yaxes=False+symbol-color=black+viz=site-reservation-at-ranks-heatmap.../+ext=.pdf}
  \end{subfigure}%
...
% \includegraphics[width=\textwidth, clip, trim={0 0 1.25cm 11.2cm}]{binder/teeplots/20/surface-size=16+viz=site-reservation-at-ranks-heatmap+ext=.pdf}\vspace{-1ex}
...
% \end{subfigure}%
\begin{subfigure}{0.5\textwidth}
\includegraphics[width=\textwidth, clip, trim={0 0 1.25cm 11.2cm}]{binder-20a-tilted-eulerian-surface/binder/teeplots/20a/color-epoch-t=black+color-metaepoch-tau=black+color-site-k=black+plotter=site_reservation_size_at_rank_heatmap+surface-size=16+swap-yaxes=False+symbol-color=black+viz=site-reservation-at-ranks-heatmap.../+ext=.pdf}\vspace{-1ex}
