...
\vspace{-2ex}
  ...
  \begin{subfigure}[b]{0.98\linewidth}
    ...
    \node [
      above right,
      inner sep=0] (image) at (0,0) {\includegraphics[width=0.989\textwidth, trim={0.7cm 0cm 1.4cm 5.6cm}, clip]{binder/teeplots/11/reservation-mode=steady+surface-size=32+viz=site-reservation-at-ranks-heatmap+ext=.pdf}};
...
\draw[stealth-, ultra thick, gray](0.37+0.3,1.1+2.68) -- ++(0, -0.5) node[font=\footnotesize] at (1.62+0.3, 2.38+1.1) {incidence $i=0$ of $\colorH(\colorT)=6$ at $\colorT=63$};
\draw[stealth-, ultra thick, gray](2.21+0.3,1.1+3.84) -- ++(0, -0.5) node[font=\footnotesize] at (2.45+0.3, 3.5+1.1) {$i=1$~~~of $\colorH(\colorT)=6$};
\draw[stealth-, ultra thick, gray](3.74-0.6,1.1+4.9) -- ++(0, -0.5) node[font=\footnotesize] at (3.53-0.6, 4.61+1.1) {$i=2$};
\draw[stealth-, ultra thick, gray](4.66-0.6,1.1+4.9) -- ++(0, -0.5) node[font=\footnotesize] at (4.45-0.6, 4.61+1.1) {$i=3$};
\draw[stealth-, ultra thick, gray](5.27-0.3,1.1+5.96) -- ++(0, -0.5) node[font=\footnotesize] at (5.06-0.3, 5.67+1.1) {$i=4$};
\draw[stealth-, ultra thick, gray](5.88-0.3,1.1+5.96) -- ++(0, -0.5) node[font=\footnotesize] at (5.67-0.3, 5.71+1.1) {$i=5$};
\draw[stealth-, ultra thick, gray](6.5-0.3,1.1+5.96) -- ++(0, -0.5) node[font=\footnotesize] at (6.29-0.3, 5.71+1.1) {$i=6$};
\draw[stealth-, ultra thick, gray](7.12-0.3,1.1+5.96) -- ++(0, -0.5) node[font=\footnotesize] at (6.91-0.3, 5.68+1.1) {$i=7$};
\draw[stealth-, ultra thick, gray](7.41,1.1+7.06) -- ++(0, -0.5) node[font=\footnotesize] at (7.30, 6.65+1.1) {$8$};
\draw[stealth-, ultra thick, gray](7.72,1.1+7.06) -- ++(0, -0.5) node[font=\footnotesize] at (7.61, 6.65+1.1) {$9$};
\draw[stealth-, ultra thick, gray](8.02,1.1+7.06) -- ++(0, -0.5) node[font=\footnotesize] at (7.91, 6.65+1.1) {$10$};
\draw[stealth-, ultra thick, gray](8.32,1.1+7.06) -- ++(0, -0.5) node[font=\footnotesize] at (8.21, 6.65+1.1) {$11$};
\draw[stealth-, ultra thick, gray](8.61,1.1+7.06) -- ++(0, -0.5) node[font=\footnotesize] at (8.5, 6.65+1.1) {$12$};
\draw[stealth-, ultra thick, gray](8.94,1.1+7.06) -- ++(0, -0.5) node[font=\footnotesize] at (8.83, 6.65+1.1) {$13$};
\draw[stealth-, ultra thick, gray](9.25,1.1+7.06) -- ++(0, -0.5) node[font=\footnotesize] at (9.14, 6.65+1.1) {$14$};
\draw[stealth-, ultra thick, gray](9.55,1.1+7.06) -- ++(0, -0.5) node[font=\footnotesize] at (9.44, 6.65+1.1) {$15$};
    \end{scope}
