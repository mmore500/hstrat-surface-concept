...
\draw[stealth-, ultra thick, seabornBrown](0.37,2.68) -- ++(0, -0.5) node[font=\footnotesize] at (0.9, 2.46) {incidence $i=0$};
\draw[stealth-, ultra thick, seabornBrown](2.21,3.84) -- ++(0, -0.5) node[font=\footnotesize] at (2.0, 3.5) {$i=1$};
