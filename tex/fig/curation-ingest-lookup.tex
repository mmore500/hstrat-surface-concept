...
\includegraphics[height=3in, trim={0 0 8.2cm 0}, clip]{img/ring-buffer-simple-serif}
}
\endgroup
\end{subfigure}%
\vrule
...
\includegraphics[height=3in, trim={1.33cm 0 0 0}, clip]{img/ring-buffer-simple-serif}\\
\vspace{1ex}
\end{minipage}
}
\endgroup
...
\includegraphics[height=3in, trim={1.33cm 0 0 0}, clip]{img/ring-buffer-steady-serif}\\
\vspace{1ex}
\end{minipage}
}
\endgroup
...
\includegraphics[height=3in, trim={1.33cm 0 0 0}, clip]{img/ring-buffer-tilted-serif}\\
\vspace{1ex}
\end{minipage}
}
\endgroup
