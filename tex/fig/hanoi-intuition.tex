...
\includegraphics[trim={0.2cm 1.2cm 0 0},clip,height=0.65in]{binder/teeplots/hanoi-strategy/hue=hanoi-value+viz=lolliplot+what=top-n-after+x=index+y=hanoi-value+ext=.pdf}%
\end{minipage}}%
% \hspace{-1ex}%
% {\vrule width 1pt}%
% \noindent\fcolorbox{pink!6}{pink!6}{%
% \begin{minipage}[]{0.31\linewidth}
% \includegraphics[trim={1cm 1.2cm 0 0},clip,height=0.65in]{binder/teeplots/hanoi-strategy/hue=hanoi-value+viz=lolliplot+what=first-n-after-alt+x=index+y=hanoi-value+ext=.pdf}%
% \end{minipage}}%
\hspace{-1ex}%
{\vrule width 1pt}%
\noindent\fcolorbox{purple!5}{purple!5}{%
\begin{minipage}[]{0.31\linewidth}
\includegraphics[trim={1cm 1.2cm 0 0},clip,height=0.65in]{binder/teeplots/hanoi-strategy/hue=hanoi-value+viz=lolliplot+what=last-n-after-alt+x=index+y=hanoi-value+ext=.pdf}%
...
\includegraphics[trim={0.2cm 0 0 0},clip,height=0.84in]{binder/teeplots/hanoi-strategy/hue=hanoi-value+viz=lolliplot+what=top-n-before+x=index+xlim=100+y=hanoi-value+ext=.pdf}%
\end{minipage}}%
\hspace{-1ex}%
% {\vrule width 1pt}%
% \noindent\fcolorbox{pink!15}{pink!15}{%
% \begin{minipage}[c]{0.31\linewidth}
% \includegraphics[trim={1cm 0 0 0},clip,height=0.84in]{binder/teeplots/hanoi-strategy/hue=hanoi-value+viz=lolliplot+what=first-n-before+x=index+xlim=100+y=hanoi-value+ext=.pdf}%
% \end{minipage}}%
% \hspace{-1ex}%
{\vrule width 1pt}%
\noindent\fcolorbox{purple!11}{purple!11}{%
\begin{minipage}[]{0.31\linewidth}
\includegraphics[trim={1cm 0 0 0},clip,height=0.84in]{binder/teeplots/hanoi-strategy/hue=hanoi-value+viz=lolliplot+what=last-n-before+x=index+xlim=100+y=hanoi-value+ext=.pdf}%
\end{minipage}\hspace{-1ex}}%
\end{minipage}\vspace{-1ex}
