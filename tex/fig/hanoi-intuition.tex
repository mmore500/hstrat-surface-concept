...
\begin{subfigure}{\linewidth}
  ...
  \fcolorbox{purple!5}{purple!5}{%
    \begin{minipage}[c][1.68in][c]{0.4\linewidth}
      \hspace{-2ex}
      \vspace{-3ex}
      \begin{tikzpicture}[>=Stealth,decoration={brace}]
        ...
        \draw[->] ($(imgA.east)+(-0.19,1.20)$) -- ($(imgA.east)+(-0.4,1.20)$);
        \node[inner sep=2pt,right] at ($(imgA.east)+(-0.35,1.20)$) {\small \; $1\times \boxnum{C5}{5}$};
        \draw[->] ($(imgA.east)+(-0.19,0.80)$) -- ($(imgA.east)+(-0.4,0.80)$);
        \node[inner sep=2pt,right] at ($(imgA.east)+(-0.35,0.80)$) {\small \; $1\times \boxnum{C4}{4}$};
        \draw[->] ($(imgA.east)+(-0.19,0.40)$) -- ($(imgA.east)+(-0.4,0.40)$);
        \node[inner sep=2pt,right] at ($(imgA.east)+(-0.35,0.40)$) {\small \; $2\times \boxnum{C3}{3}$};
        \draw[->] ($(imgA.east)+(-0.19,0)$) -- ($(imgA.east)+(-0.4,0)$);
        \node[inner sep=2pt,right] at ($(imgA.east)+(-0.35,0)$) {\small \; $4\times \boxnum{C2}{2}$};
        \draw[->] ($(imgA.east)+(-0.19,-0.40)$) -- ($(imgA.east)+(-0.4,-0.40)$);
        \node[inner sep=2pt,right] at ($(imgA.east)+(-0.35,-0.40)$) {\small \; $4\times \boxnum{C1}{1}$};
        \draw[->] ($(imgA.east)+(-0.19,-0.80)$) -- ($(imgA.east)+(-0.4,-0.80)$);
        \node[inner sep=2pt,right] at ($(imgA.east)+(-0.35,-0.80)$) {\small \; $4\times \boxnum{C0}{0}$};
        \draw[line width=1.4pt,decorate,decoration={brace,amplitude=4pt}]
              ($(imgA.east)+(-0.15,1.50)$) -- ($(imgA.east)+(0.6,1.50)$)
              node[midway,anchor=south,yshift=0.19cm,align=center,xshift=-2.9cm]%
              {\Large Keep up to $4$ most recent items of each \hv{}\\(If $<4$ items of \hv{} seen, keep all \hv{} items.)};
      \end{tikzpicture}
      \hspace*{\fill}%
    \end{minipage}}\\[-1ex]
  ...
  \fcolorbox{purple!11}{purple!11}{%
    \begin{minipage}[c][1.7in][c]{0.4\linewidth}
      ...
      \begin{tikzpicture}[>=Stealth,decoration={brace}]
        ...
        \draw[->] ($(imgB.east)+(-0.19,0.80)$) -- ($(imgB.east)+(-2.87,0.80)$);
        \node[inner sep=2pt,right] at ($(imgB.east)+(-0.35,0.80)$) {\small \; $1\times \boxnum{C4}{4}$};
        \draw[->] ($(imgB.east)+(-0.19,0.40)$) -- ($(imgB.east)+(-2.87,0.40)$);
        \node[inner sep=2pt,right] at ($(imgB.east)+(-0.35,0.40)$) {\small \; $1\times \boxnum{C3}{3}$};
        \draw[->] ($(imgB.east)+(-0.19,0)$) -- ($(imgB.east)+(-2.87,0)$);
        \node[inner sep=2pt,right] at ($(imgB.east)+(-0.35,0)$) {\small \; $2\times \boxnum{C2}{2}$};
        \draw[->] ($(imgB.east)+(-0.19,-0.40)$) -- ($(imgB.east)+(-2.87,-0.40)$);
        \node[inner sep=2pt,right] at ($(imgB.east)+(-0.35,-0.40)$) {\small \; $4\times \boxnum{C1}{1}$};
        \draw[->] ($(imgB.east)+(-0.19,-0.80)$) -- ($(imgB.east)+(-2.87,-0.80)$);
        \node[inner sep=2pt,right] at ($(imgB.east)+(-0.35,-0.80)$) {\small \; $8\times \boxnum{C0}{0}$};
        \draw[line width=1.4pt,decorate,decoration={brace,amplitude=4pt}]
              ($(imgB.east)+(-0.15,1.10)$) -- ($(imgB.east)+(0.6,1.10)$)
              node[midway,anchor=south,yshift=0.19cm,align=center,xshift=-2.9cm]%
              {\Large Keep up to $8$ most recent items of each \hv{}\\(If $<8$ items of \hv{} seen, keep all \hv{} items.)};
      \end{tikzpicture}
      \vspace{-0.7cm}
      \hspace*{\fill}%
    \end{minipage}}
...
\begin{subfigure}{\linewidth}
  ...
  \begin{tikzpicture}
    ...
    \begin{scope}[x={(X.south east)},y={(X.north west)}]
      ...
      % annotation rows
      \node[text width=2in] at ($(X.south west) - (0.6cm, 0) + (4.56cm, 7.8cm)$) {%
      ...
      \node[text width=1.5in] at ($(X.south west) - (0.6cm, 0) + (4.1cm, 6.73cm)$) {%
