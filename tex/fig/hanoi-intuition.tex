    ...
    \begin{minipage}[c][1.68in][c]{0.4\linewidth}
      ...
      \begin{tikzpicture}[>=Stealth,decoration={brace}]
        ...
        \draw[line width=1.4pt,decorate,decoration={brace,amplitude=4pt}]
              ...
              node[midway,anchor=south,yshift=0.19cm,align=center,xshift=-2.65cm]%
              {\Large Keep $4$ most recent items of each \hv{}\\(If $<4$ items of \hv{} seen, keep all \hv{} items.)};
      \end{tikzpicture}
      \hspace*{\fill}%
    \end{minipage}}\\[-1ex]
    ...
    \begin{minipage}[c][1.7in][c]{0.4\linewidth}
      ...
      \begin{tikzpicture}[>=Stealth,decoration={brace}]
        ...
        \draw[line width=1.4pt,decorate,decoration={brace,amplitude=4pt}]
              ...
              node[midway,anchor=south,yshift=0.19cm,align=center,xshift=-2.65cm]%
              {\Large Keep $8$ most recent items of each \hv{}\\(If $<8$ items of \hv{} seen, keep all \hv{} items.)};
      \end{tikzpicture}
      \vspace{-0.7cm}
      \hspace*{\fill}%
    \end{minipage}}
