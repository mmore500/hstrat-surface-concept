...
\begin{subfigure}{\linewidth}
  ...
  \fcolorbox{purple!5}{purple!5}{%
    \begin{minipage}[c][1.30in][c]{0.44\linewidth}
      \begin{tikzpicture}[>=Stealth,decoration={brace}]
        ...
        \draw[line width=1.4pt,decorate,decoration={brace,amplitude=4pt}] ($(imgA.east)+(0.3,1.40)$) -- ($(imgA.east)+(1.15,1.40)$)
  ...
  \fcolorbox{purple!11}{purple!11}{%
    \begin{minipage}[c][1.48in][c]{0.44\linewidth}
      \vspace{-1.3cm}
      \begin{tikzpicture}[>=Stealth,decoration={brace}]
        ...
        \draw[line width=1.4pt,decorate,decoration={brace,amplitude=4pt}] ($(imgB.east)+(0.3,1.00)$) -- ($(imgB.east)+(1.15,1.00)$)
