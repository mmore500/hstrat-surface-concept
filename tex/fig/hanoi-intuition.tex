...
\begin{subfigure}{\linewidth}
  ...
  \fcolorbox{gray!3}{gray!3}{%
    \begin{minipage}[c][0.15in][c]{0.355\linewidth}\centering
      \Large Meta-epoch $\colortau = 1$ \normalsize (@ Time $\colorT = 32$)
    \end{minipage}}\\[-0.25ex]
  \fcolorbox{purple!5}{purple!5}{%
    \begin{minipage}[c][2.4in][c]{0.355\linewidth}
  ...
  \fcolorbox{purple!11}{purple!11}{%
    \begin{minipage}[c][2.4in][c]{0.355\linewidth}
      ...
      \begin{tikzpicture}[decoration={brace}]
        ...
        \node[anchor=south west,align=center] at ($(imgB.east)+(-6.28,2.70)+(0,0.19)$)
