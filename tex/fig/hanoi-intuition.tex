...
\begin{subfigure}{\linewidth}
  ...
  \fcolorbox{gray!3}{gray!3}{%
    \begin{minipage}[c][0.15in][c]{0.4\linewidth}\centering
      Meta-epoch $\colortau = 1$ (@ Time $\colorT = 32$)
    \end{minipage}}\\[-0.25ex]
  \fcolorbox{purple!5}{purple!5}{%
    \begin{minipage}[c][2.4in][c]{0.4\linewidth}
      ...
      \begin{tikzpicture}[decoration={brace}]
        ...
        \end{scope}
      \end{tikzpicture}\hspace*{\fill}\end{minipage}}\\[1.1em]

  \fcolorbox{gray!11}{gray!11}{%
    \begin{minipage}[c][0.15in][c]{0.4\linewidth}\centering
      Meta-epoch $\colortau = 0$ (@ Time $\colorT = 16$)
    \end{minipage}}\\[-0.25ex]
