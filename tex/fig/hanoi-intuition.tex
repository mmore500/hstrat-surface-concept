    ...
    \begin{minipage}[c][1.30in][c]{0.90\linewidth}
      ...
      \begin{tikzpicture}[>=Stealth,decoration={brace}]
        ...
        \draw[line width=1.4pt,decorate,decoration={brace,amplitude=4pt}] ($(imgA.east)+(1.7,1.30)$) -- ($(imgA.east)+(1.7,-0.90)$)
          node[midway,anchor=west,xshift=0.34cm,align=center] {\Large Keep up to $4$ most recent items of each \hv{}\\(If $<4$ items of \hv{} seen, keep all \hv{} items.)};
      \end{tikzpicture}
      \hspace*{\fill}%
    \end{minipage}}\\[-1ex]
    ...
    \begin{minipage}[c][1.48in][c]{0.90\linewidth}
      ...
      \begin{tikzpicture}[>=Stealth,decoration={brace}]
        ...
        \draw[line width=1.4pt,decorate,decoration={brace,amplitude=4pt}] ($(imgB.east)+(1.7,0.90)$) -- ($(imgB.east)+(1.7,-0.90)$)
          node[midway,anchor=west,xshift=0.34cm,align=center] {\Large Keep up to $8$ most recent items of each \hv{}\\(If $<8$ items of \hv{} seen, keep all \hv{} items.)};
      \end{tikzpicture}
      \vspace{-0.7cm}
      \hspace*{\fill}%
    \end{minipage}}
