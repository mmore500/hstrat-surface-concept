...
\begin{subfigure}{\linewidth}
  ...
  \fcolorbox{purple!5}{purple!5}{%
    \begin{minipage}[c][2.4in][c]{0.355\linewidth}
      ...
      \newsavebox{\binderfull}
      \sbox{\binderfull}{\includegraphics[trim={0 0 0 0},clip,width=\wd\bindertrim]{binder-hanoi-strategy-small-epoch/binder/teeplots/hanoi-strategy-small-epoch/font.family=serif+hue=hanoi-value+viz=lolliplot+what=last-n-before+x=index+xlim=32+y=hanoi-value+ext=.pdf}}
      \def\Shift{0.29}
      ...
      \fcolorbox{purple!11}{purple!11}{%
        \begin{minipage}[c][2.3in][c]{0.355\linewidth}
