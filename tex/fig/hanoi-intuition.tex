    ...
    \begin{minipage}[c][1.30in][c]{0.90\linewidth}
      ...
      \begin{tikzpicture}[>=Stealth,decoration={brace}]
        ...
        \draw[line width=1.4pt,decorate,decoration={brace,amplitude=4pt}] ($(imgA.east)+(1.7,1.30)$) -- ($(imgA.east)+(1.7,-0.90)$)
          node[midway,anchor=west,xshift=0.19cm] {\Large Keep at least last $4\times$ seen items of each \hv{}};
      \end{tikzpicture}
      \hspace*{\fill}%
    \end{minipage}}\\[-1ex]
    ...
    \begin{minipage}[c][1.48in][c]{0.90\linewidth}
      ...
      \begin{tikzpicture}[>=Stealth,decoration={brace}]
        ...
        \draw[line width=1.4pt,decorate,decoration={brace,amplitude=4pt}] ($(imgB.east)+(1.7,0.90)$) -- ($(imgB.east)+(1.7,-0.90)$)
          node[midway,anchor=west,xshift=0.19cm] {\Large Keep at least last $8\times$ seen items of each \hv{}};
      \end{tikzpicture}
      \vspace{-0.7cm}
      \hspace*{\fill}%
    \end{minipage}}
...
\begin{subfigure}{\linewidth}
  ...
  \begin{tikzpicture}
    ...
    \begin{scope}[x={(X.south east)},y={(X.north west)}]
      ...
      \Large Keep at least last $1\times$ seen items of each \hv{}
      };
      ...
      \Large Keep at least last $2\times$ seen items of each \hv{}
      };
