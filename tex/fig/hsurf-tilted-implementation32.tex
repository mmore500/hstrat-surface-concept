...
\label{fig:hsurf-tilted-implementation-site-selection32}
\end{subfigure}
\vspace{-3ex}
...
\label{fig:hsurf-tilted-implementation-schematic32}
\end{subfigure}
...
%   }
%   \label{fig:hsurf-tilted-implementation-heatmap32}
% \end{subfigure}
% \end{minipage}
...
%   }
%   \label{fig:hsurf-tilted-implementation-dripplot32}
%   \end{subfigure}
%   \end{minipage}
...
% }
% \label{fig:hsurf-tilted-implementation-satisfaction32}
% \end{subfigure}
% \end{minipage}
...
\label{fig:hsurf-tilted-implementation32}
