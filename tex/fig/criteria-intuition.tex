...
\begin{minipage}[t]{\linewidth}
    ...
    \includegraphics[trim={0 0.6cm 0 0},clip,width=\linewidth]{binder-coverage-criteria-small/binder/teeplots/coverage-criteria-small/criterion=steady+font.family=serif+stop=100+viz=rugplot+ext=.pdf}%
    \end{minipage}}%
    {\vrule width 1pt}%
    \noindent\fcolorbox{purple!4}{purple!4}{%
    \begin{minipage}[c][0.4in]{0.45\textwidth}
    \includegraphics[trim={0 0.6cm 0 0},clip,width=\linewidth]{binder-coverage-criteria-small/binder/teeplots/coverage-criteria-small/criterion=tilted+font.family=serif+stop=100+viz=rugplot+ext=.pdf}%
    \end{minipage}}%
