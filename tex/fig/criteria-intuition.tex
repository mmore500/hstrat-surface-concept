...
\begin{minipage}[t]{\linewidth}
    ...
    \includegraphics[trim={0 0.7cm 0 0},clip,width=\linewidth]{binder-new/teeplots/coverage-criteria-small/criterion=steady+stop=100+viz=rugplot+ext=.pdf}%
    \end{minipage}}%
    {\vrule width 1pt}%
    \noindent\fcolorbox{purple!4}{purple!4}{%
    \begin{minipage}[c][0.4in]{0.45\textwidth}
    \includegraphics[trim={0 0.7cm 0 0},clip,width=\linewidth]{binder-new/teeplots/coverage-criteria-small/criterion=tilted+stop=100+viz=rugplot+ext=.pdf}%
    \end{minipage}}%
    ...
    \begin{minipage}[c][0.4in]{0.45\textwidth}
    \includegraphics[trim={0 0.1cm 0 0},clip,width=\linewidth]{binder-new/teeplots/coverage-criteria-small/criterion=steady+stop=50+viz=rugplot+ext=.pdf}%
    \end{minipage}}%
    {\vrule width 1pt}%
    \noindent\fcolorbox{purple!10}{purple!10}{%
    \begin{minipage}[c][0.4in]{0.45\textwidth}
    \includegraphics[trim={0 0.1cm 0 0},clip,width=\linewidth]{binder-new/teeplots/coverage-criteria-small/criterion=tilted+stop=50+viz=rugplot+ext=.pdf}%
    \end{minipage}}%
