\begin{figure*}
  ...
  The ingested time calculation operation (\ref{fig:deposit-rank-calculation}) provides the previous time $\colorT'$ when the data item present at buffer site $\colork$ was ingested, given the current time $\colorT$.
