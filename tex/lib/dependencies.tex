...
% workaround ! LaTeX Error: Too many math alphabets used in version normal.
% adapted from https://tex.stackexchange.com/a/243541/316176
\newcommand\hmmax{0}
\newcommand\bmmax{0}
...
\usepackage{tikz}
% \usepackage{stix}
% adapted from https://tex.stackexchange.com/a/331899/316176
% and https://www.tug.org/texlive//Contents/live/texmf-dist/tex/latex/stix/stix.sty
\makeatletter
...
\makeatletter
% 1) Declare an LS1 encoding, and a default substitution mapping to ‘stix’
\DeclareFontEncoding{LS1}{}{}
\DeclareFontSubstitution{LS1}{stix}{m}{n}

% 2) Pick the STIX "bb" (“blackboard”) sub-family in italic
%    that STIX uses for symbols4
\DeclareSymbolFont{symbols4}{LS1}{stixbb}{m}{it}

% 3) Finally, map the specific glyph at slot "E7 in ‘symbols4’ to \blkhorzoval
\DeclareMathSymbol{\blkhorzoval}{\mathord}{symbols4}{"E7}
\makeatother
...
% adapted from https://tex.stackexchange.com/a/641668/316176
...
\newcommand{\colort}{\mathcolor{black}{\mathrm{t}}}
\newcommand{\colortsetofT}{\lBrace \colort \rBrace}
\newcommand{\colortsetofTone}{\lBrace \colort + 1 \rBrace}
\newcommand{\colortau}{\mathcolor{black}{\ctau}}
\newcommand{\colortausetoft}{\lBrace \colortau \rBrace}
\newcommand{\colortausetofT}{\{\hspace{-0.5ex}\lBrace \colortau \rBrace\hspace{-0.5ex}\}}
\newcommand{\colorT}{\mathcolor{black}{T}}
\newcommand{\colorTbar}{\mathcolor{black}{\widecheck{T}}}

\newcommand{\colork}{\mathcolor{black}{k}}
\newcommand{\colors}{\mathcolor{black}{\hat{\mathrm{s}}}}
\newcommand{\colorS}{\mathcolor{black}{S}}  % BlueViolet
\newcommand{\colorK}{\mathcolor{black}{\mathrm{K}}}

\newcommand{\colorh}{\mathcolor{black}{h}}
\newcommand{\colorH}{\mathcolor{black}{\mathrm{H}}}
\newcommand{\colorHcal}{\mathcolor{black}{\mathcal{H}}}

\newcommand{\colorL}{\mathcolor{black}{\mathrm{L}}}

\newcommand{\colorB}{\mathcolor{black}{\mathcal{B}}}
\newcommand{\colorBnot}{\mathcolor{black}{\cancel{\mathcal{B}}}}

\newcommand{\colorg}{\mathcolor{black}{g}}
\newcommand{\colorG}{\mathcolor{black}{G}}

\let\mycheckmark\checkmark
\renewcommand{\checkmark}{\textcolor{black}{\mycheckmark}}
