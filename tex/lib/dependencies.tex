...
\newcommand{\adjustedaccent}[1]{%
  \mathchoice{}{}
    {\mbox{\raisebox{-.85ex}[0pt][0pt]{$\scriptscriptstyle#1$}}}
    {\mbox{\raisebox{-.65ex}[0pt][0pt]{\scalebox{.8}{$\scriptscriptstyle#1$}}}}
}
...
\newcommand{\colorTbar}{\mathcolor{red}{\smileacc{T}}}

\newcommand{\colork}{\mathcolor{purple}{k}}
\newcommand{\colors}{\mathcolor{blue}{\mathrm{s}}}
\newcommand{\colorS}{\mathcolor{BlueViolet}{\mathcal{S}}}
