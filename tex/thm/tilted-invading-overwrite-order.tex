...
\Big).
\end{align*}
\annotate[yshift=1em]{above,right}{hanoitime1,hanoitime2,hanoitime3}{$1,2,\,\ldots,\left\lceil2^{\colors - 1 - \colortau}\right\rceil - 1$}
...
The result follows from algorithm specification, with each h.v. filling its own newly-allocated reservation sites from left to right.
\end{proof}
