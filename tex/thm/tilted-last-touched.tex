...
\begin{proof}
Because we are only concerned with pertinent \hv{} $\colorh \in \{\colorH(\colorT) : \colorT \in \colort\}$, we may assume $\colorh \leq \colors + \colort$.
...
\annotate[yshift=1em]{above,right}{numsitesh}{$|\{
  \colork \in \colorS : \colorHcal_{\colort}(\colork) = \colorh
\}|$}
