...
\{ \colorTbar = i2^{\colorh + 1} + 2^{\colorh} - 1 \text{ for } i \in [0 \twodots n(\colorT) - 1] : \colorTbar < \colorT \}| \leq \colorS
\end{align*}
...
&=
\sum_{\colorh} \min\Big(
\eqnmarkbox[gray]{sonetau}{2^{\colors - 1 - \colortau}},\;\; |\{ \colorTbar < \colorT : \colorH(\colorTbar) = \colorh \}|\Big)\\
&=
