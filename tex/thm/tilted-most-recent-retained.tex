\begin{lemma}[Most-recent h.v. instances retained]
...
In this case, again from Lemma \ref{thom:stretched-discarded-incidence-count}, we have the number of reserved sites as dropping from $2^{\colors - \colortau}$ to $2^{\colors - 1 - \colortau}$.
