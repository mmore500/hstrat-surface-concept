...
% With \hv{} $\colorh=0$ always first to be invaded, this occurs at the opening epoch of each meta-epoch $\min\{\colort \in \colortau\}$ and so remains consistent within each meta-epoch.
% Thus,
