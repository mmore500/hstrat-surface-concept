...
\frac{\left\lfloor \frac{\colorT - 2^{\eqnmarkbox[YellowGreen]{}{\colorH(\colorTbar)}} + 1}{2^{\eqnmarkbox[SkyBlue]{}{\colorh'}}} \right\rfloor}{2^{\colorH(\colorTbar) \eqnmarkbox[SkyBlue]{}{-\colorh'} + 1}}
...
\in \mathbb{Z}.
\end{align*}
Further, because $0 \leq \epsilon \leq 1$, $j' \in \{0,1,\,\ldots,2n-1\}$, and $\colorH(\colorTbar) - \colorh'  + 1 \geq 1$,
\begin{align*}
\frac{j'}{2^{\colorH(\colorTbar) - \colorh' + 1}}
- \epsilon
...
\{0, 1, \,\ldots, n - 1\}.
\end{align*}
With $\colorh = \colorH(\colorTbar) - \colorh' + 1 \stackrel{\checkmark}{\in} \mathbb{N}$ we have the result, $\mathsf{want\_retained} \stackrel{\checkmark}{\subseteq} \mathsf{have\_retained}$.
\end{proof}
