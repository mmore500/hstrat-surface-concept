...
\frac{\left\lfloor \frac{\colorT + 1}{2^{\colorh'}} - 2^{\eqnmarkbox[YellowGreen]{}{\colorH(\colorTbar)} - \colorh'} \right\rfloor}{2^{\colorH(\colorTbar) - \colorh' \eqnmarkbox[Orchid]{}{+ 1}}}
-
...
\frac{\left\lfloor \frac{\colorT - 2^{\eqnmarkbox[YellowGreen]{}{\colorH(\colorTbar)}} + 1}{2^{\colorh'}} \right\rfloor}{2^{\colorH(\colorTbar) - \colorh' + 1}}
-
...
\begin{align*}
  ...
  2^{\colorboxed{orange}{\colorH(\colorTbar)} + 1} \Big(
    \frac{\left\lfloor \frac{\colorT - 2^{\colorH(\colorTbar)} + 1}{2^{\colorh'}} \right\rfloor}{2^{\colorH(\colorTbar) - \colorh' + 1}}
    -
    \frac{j'}{2^{\colorH(\colorTbar) - \colorh' + 1}}
    \Big)
...
% \end{align*}
Dividing by 2 and letting $\epsilon \in \{0, 1\}$ denote a continuity correction factor for the integer floor,
\begin{align*}
\frac{\left\lfloor \frac{\colorT - 2^{\colorH(\colorTbar)} + 1}{2^{\eqnmarkbox[SkyBlue]{}{\colorh'}}} \right\rfloor}{2^{\colorH(\colorTbar) \eqnmarkbox[SkyBlue]{}{- \colorh'} + 1}}
-
\frac{j'}{2^{\colorH(\colorTbar) - \colorh' + 1}}
&=
\left\lfloor
