...
So, $\colorG_{\colorT}(\colorTbar) \leq \left\lceil \frac{\colorTbar + 1 }{2n} \right\rceil_{\mathrm{bin}} - 1$.
Thus, for $\colorTbar > 0$, gap size ratio $\mathsf{cost\_stretched}(\colorT)$ can be bounded
\begin{align*}
