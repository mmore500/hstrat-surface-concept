...
project = u'Hereditary Stratigraphic Surface Concept'
...
latex_documents = [
    (master_doc, 'hstrat-surface-concept.tex',
     u'Hereditary Stratigraphic Surface Concept Documentation',
...
man_pages = [
    (master_doc, 'hstrat-surface-concept',
     u'Hereditary Stratigraphic Surface Concept Documentation',
     [author], 1)
]
