...
from hsurf.site_selection_strategy.site_selection_algorithms.tilted_hadamard_order_site_rungs_algo._scry._impl import (
...
def test_calc_incidence_of_ingested_hanoi_value_smoke(
    ...
    for reservation_index in range(num_reservations_provided):
        ...
        if hanoi_count > reservation_index:
            actual_result = calc_incidence_of_ingested_hanoi_value(
