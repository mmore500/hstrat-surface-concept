...
def test_calc_resident_ingest_rank_unit():
    assert [
        algo.calc_resident_ingest_rank(0, 16, num_ingests)
    ...
    assert [
        algo.calc_resident_ingest_rank(1, 16, num_ingests)
        for num_ingests in range(23)
    ] == [
        # fmt: off
            # ingest site
    ...
    assert [
        algo.calc_resident_ingest_rank(2, 16, num_ingests)
        for num_ingests in range(23)
    ] == [
        # fmt: off
            # ingest site
    ...
    assert [
        algo.calc_resident_ingest_rank(15, 16, num_ingests)
        for num_ingests in range(23)
    ] == [
        # fmt: off
            # ingest site
    ...
    assert [
        algo.calc_resident_ingest_rank(8, 16, num_ingests)
        for num_ingests in range(23)
    ] == [
        # fmt: off
            # ingest site
    ...
    assert [
        algo.calc_resident_ingest_rank(9, 16, num_ingests)
        for num_ingests in range(23)
    ] == [
        # fmt: off
            # ingest site
...
def test_calc_resident_ingest_rank_integration(
    ...
    for rank in range(num_generations):
        ...
        for site, actual_ingest_rank in enumerate(
